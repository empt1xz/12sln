    ...
    <>
      <footer className={Style.footer}>
        <div className={Style.aboutus}>
          ...
          <p className={Style.p_aboutus}>
            12sln é uma startup de tecnologia fundada por 12 desenvolvedores
            profissionais que vão te guiar para a soluçao do seu problema.
          </p>
        </div>
