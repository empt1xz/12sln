...
const faq_items = [
    {
      ...
      answer: 'Os valores dos projetos dependem do escopo e complexidade. Um site institucional simples fica na faixa mais acessível, enquanto um app com funcionalidades personalizadas chega ao topo da faixa. O valor exato só definimos após entender o que você precisa,por isso a primeira conversa é sempre sem compromisso.'  
    },

    {
        question: 'Quanto tempo leva para ficar pronto?',
        answer: 'Depende do projeto, mas para te dar uma referência: sites ficam prontos em 2 a 4 semanas, e apps ou softwares costumam levar de 6 a 12 semanas. O prazo real combinamos na proposta, depois de entender bem o seu escopo. Trabalhamos com etapas e entregas parciais, então você acompanha o progresso do início ao fim.'
    },
...

    {
        ...
        answer: 'O código é 100% seu desde o primeiro dia. Entregamos o projeto completo no seu repositório (GitHub ou similar), com documentação de como rodar e editar tudo. Você pode levar para outro desenvolvedor, contratar alguém interno ou continuar com a gente, a escolha é sempre sua.'
    },

    {
        question: 'Preciso saber de tecnologia para trabalhar com vocês?',
        answer: 'Não precisa saber nada de tecnologia. Nosso processo é feito para pessoas que têm uma ideia ou necessidade de negócio, não para programadores. Você nos conta o que quer resolver, nós traduzimos isso em código. Durante o projeto, a comunicação é sempre simples e em português claro, sem jargão técnico.'
    }
]
